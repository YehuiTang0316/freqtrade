...
class MFIPulse(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # MFI signals: rising from low (buying) or falling from high (selling)
        mfi_bull = (dataframe["mfi"] > 50) & (dataframe["mfi"] > dataframe["mfi_prev"])
        mfi_bear = (dataframe["mfi"] < 50) & (dataframe["mfi"] < dataframe["mfi_prev"])

        # Long: squeeze + OBV+MFI bullish + CCI strong + HA bull
        long_1 = (
            btc_ok_long
