...
class ADXSqueezePulse(IStrategy):
    """
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Long: ADX squeeze break + bullish direction
        long_adx = (
            btc_ok_long
            & (dataframe["trend_4h"] >= 0)
            & adx_was_low
            & adx_rising
            & (dataframe["plus_di"] > dataframe["minus_di"])  # bullish direction
            & (dataframe["close"] > dataframe["bb_upper"])  # price breakout
        ...
        # Long momentum: strong ADX + bullish
        long_momentum = (
            btc_ok_long
